<?php 
    ...
    if(isset($_GET["id"]))
    {
        $data1=mysqli_query($connection,"select * from butiran where pakej='$_GET[id]'");
    }
    else
    {
    ...
    <div class="container">
      ...
      <div id="navbar3" class="navbar-collapse collapse">
        <ul class="nav navbar-nav navbar-right">
          <li class="active" style="font-face:Comic Sans MS;font-weight: bold;"><a href="laporan_majlis.php">Laporan Majlis</a></li>
    ...
    <!--/.container-fluid -->
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-table"></i> Laporan Pakej
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <form name="Form1">
                        ...
                        <select  name="example" size="1" onChange="go()">
                            <?php 
                                $data3 = mysqli_query($connection,"select * from pakej");
                                if(isset($_GET["id"]))
                                {
                                ...
                                while ($info3=mysqli_fetch_array($data3)) 
                                {
                                    ...
                                    echo "<option value='laporan_pakej.php?id=$info3[id]&nama=$info3[pakej]'>$info3[pakej]</option>";
                                }
                             ?>
                        </select> 
                ...
                {
                    $dataPakej=mysqli_query($connection,"select * from pakej where id='$info1[pakej]'");
                    $infoJenis=mysqli_fetch_array($dataPakej);

                    $dataLokasi=mysqli_query($connection,"select * from majlis where id='$info1[majlis]'");
