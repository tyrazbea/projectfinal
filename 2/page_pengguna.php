    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="page_pengguna.php">Cahaya Infiniti</a>
            </div>
            <!-- Top Menu Items -->
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li class="active">
                        <a href="page_pengguna.php"><i class="fa fa-fw fa-dashboard"></i> Halaman Utama</a>
                    </li>
                    <li>
                        <a href="SButiran_pengguna.php"><i class="fa fa-fw fa-edit"></i> Kemaskini Borang Tempahan</a>
                    </li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            HALAMAN UTAMA <small>Dashboard Pengguna</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="alert alert-info alert-dismissable">
                            ...
                            <i class="fa fa-info-circle"></i>  <strong>Selamat Datang</strong> ke Dashboard Pengguna  <b class="alert-link"><?php echo $_SESSION['email']; ?> </b>
                        </div>
                    </div>
                </div>
                <!-- /.row -->
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading"><center>
                                <h3 class="panel-title"><i class="fa fa-bar-chart-o fa-fw"></i> Selamat Datang Ke Dashboard Pengguna</h3></center>
                            </div>
