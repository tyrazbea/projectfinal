    ...
    <div class="container">
      ...
      <div id="navbar3" class="navbar-collapse collapse">
        <ul class="nav navbar-nav navbar-right">
          <li class="active" style="font-face:Comic Sans MS;font-weight: bold;"><a href="page_pengguna.php">Halaman Utama</a></li>
...
<h3 style="text-align: center;">SENARAI BUTIRAN TEMPAHAN</h3><br><fieldset>
		...
		echo $email;
			...
			$data1 = mysqli_query($connection,"select * from butiran where Emel = '$email' ");
			$no=1;
...
//<!--INSERT INTO `butiran`(`id`, `No_Daftar`, `Nama`, `Emel`, `No_Tel`, `Alamat`, `Jenis_Majlis`, `Jenis_Pakej`, `Tarikh_Majlis`, `KategoriLokasiMajlis`, `JumlahTetamu`, `catatan`) VALUES ([value-1],[value-2],[value-3],[value-4],[value-5],[value-6],[value-7],[value-8],[value-9],[value-10],[value-11],[value-12]) -->
		...
		<tr>
			...
			<td><a href="kemaskini_butiran.php?id=<?php echo $info1['id']; ?>"><button class="btn btn-warning">Kemaskini</button>
			</a></td>
		</tr>
<?php } ?>
<thead>
