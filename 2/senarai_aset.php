  ...
  <nav class="navbar navbar-inverse navbar-static-top">
    <div class="container">
      ...
      <div id="navbar3" class="navbar-collapse collapse">
        ...
        <li class="active" style="font-face:Comic Sans MS;font-weight: bold;"><a href="hapus_butiran.php">Padam Butiran</a></li>
...
//<!--INSERT INTO `butiran`(`id`, `No_Daftar`, `Nama`, `Emel`, `No_Tel`, `Alamat`, `Jenis_Majlis`, `Jenis_Pakej`, `Tarikh_Majlis`, `KategoriLokasiMajlis`, `JumlahTetamu`, `catatan`) VALUES ([value-1],[value-2],[value-3],[value-4],[value-5],[value-6],[value-7],[value-8],[value-9],[value-10],[value-11],[value-12]) -->
		...
		<tr>
			...
			<td><a href="kemaskini_aset.php?id=<?php echo $info1['id']; ?>"><button class="btn btn-warning">Kemaskini</button></td>
		</tr>
		<?php $no++;
		}
		?>
...
<a href="#" onClick="window.open ('http://127.0.0.1/stm2/2/list_pengguna.php','jenis','resizable','height = 200','width = 450'); return false;">Senarai Pengguna</a> |
